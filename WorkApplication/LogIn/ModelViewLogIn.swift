...
//MARK- subscribe to vcLog
        ...
        (vcLogIn as UIViewController).rx.viewDidAppear.asDriver().drive(onNext: { _ in
            ...
            self.vcLogIn.textFieldUsername.rx.observe(String.self, "text").asObservable().map { (string) -> Bool in
                ...
                self.vcLogIn.buttonCleanTextFieldUserNameAndRemoveUserObjectRealmIfExist.tintColor = ColorScheme.Shared.colorLVCButtonNextActive
                return true
            }
            .do(onNext: { b in
            ...
            self.vcLogIn.textFieldUsername.rx.text
                .map { (string) -> Bool in
                    ...
                    if isThreeCharts{
                        ...
                        self.vcLogIn.buttonCleanTextFieldUserNameAndRemoveUserObjectRealmIfExist.tintColor = ColorScheme.Shared.colorLVCButtonNextDontActive
                    }
